...
public final class StrHash {
    ...
    /**
     * This table was copied from <a ref="https://wiki.osdev.org/CRC32">here</a>. It also gives code
     * that constructs such a table in C++.
     *
     * <pre>
     ...
     * </pre>
     *
     * TODO: Move this large thing to another place.
     */
    private static final int[] CRC_POLY8_LOOKUP_TABLE = new int[] {
     ...
     * @return As described.
     */
    public static long polynomialRollingHash(byte @NotNull [] string) {
        return new PolynomialRollingHash(string, string.length).next();
    }
    ...
    /**
     * Traditional CRC32 algorithm. This implementation was modified from <a
     * href="https://wiki.osdev.org/CRC32">here</a>.
     *
     ...
     * @return As described.
     */
    public static int crc32(byte @NotNull [] string) {
        int crc = 0xFFFFFFFF;
        for (byte b : string) {
