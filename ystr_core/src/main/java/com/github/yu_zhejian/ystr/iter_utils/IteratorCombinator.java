...
/**
 * Combine 2 iterators by some function. If those iterators are not of equal length, will stop when
 * the shorter one exhausts.
 *
 * <p>Warning, this method may impair performance.
 *
