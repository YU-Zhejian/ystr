...
/**
 * Traditional CRC32 algorithm.
 *
 * <p><b>Implementation</b>
 *
 * <p>This implementation was modified from <a href="https://wiki.osdev.org/CRC32">here</a> with a
...
public final class CRC32Hash implements HashInterface {
    ...
    /**
     * This table was copied from <a ref="https://wiki.osdev.org/CRC32">here</a>. It can also be
     * generated by {@link #generateCrcLookupTable}.
     */
    static final int[] CRC_POLY8_LOOKUP_TABLE = {
    ...
    /**
     * Generate {@link #CRC_POLY8_LOOKUP_TABLE}.
     *
     * @return As described.
     */
    @Contract(pure = true)
    public static int @NotNull [] generateCrcLookupTable() {
        final var table = new int[StrUtils.ALPHABET_SIZE];
        int index = 0;
        do {
            table[index] = index;
            for (int z = 8; z > 0; z--) {
            ...
            ++index;
        } while (index < StrUtils.ALPHABET_SIZE);
        return table;
    }
}
